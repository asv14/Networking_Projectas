...
This project demonstrates a fully designed and configured enterprise routing environment built on GNS3 / EVE-NG, integrating Multi-Area OSPF with multiple EIGRP autonomous systems to simulate real-world inter-domain routing in a scalable network architecture.
...
Each EIGRP AS tested independently for neighbor adjacency formation, topology tables, and metric calculations.
...
Understanding of LSA types, SPF algorithm
